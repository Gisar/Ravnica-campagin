```leaflet  
id: RavnicaMapWMarks  
image: [[Равника ру с метками.png]] ### Link to the map image file  
bounds: [[0,0], [3160, 5000]] ### Size of the map in px Width_x, Height_y  
height: 850px ### Size of the leaflet embed in px on your screen  
width: 95% ### Size of the leaflet embed in your note  
lat: 1580 ### To center the map, make this half of the map width.  
long: 2500 ### To center the map, make this half of the map height.  
