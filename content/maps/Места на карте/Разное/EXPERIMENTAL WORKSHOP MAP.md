# Описание
```leaflet
id: ExperimentalWorkshop  
image: [[Pasted image 20241121010755.png]] ### Link to the map image file  
bounds: [[0,0], [1631, 1238]] ### Size of the map in px Width_x, Height_y  
height: 850px ### Size of the leaflet embed in px on your screen  
width: 95% ### Size of the leaflet embed in your note  
lat: 815 ### To center the map, make this half of the map width.  
long: 619 ### To center the map, make this half of the map height.  
